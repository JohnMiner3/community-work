# ******************************************************
# *
# * Name:         step3-load-stocks-table-storage.ps1
# *     
# * Design Phase:
# *     Author:   John Miner
# *     Date:     04-01-2018
# *     Purpose:  Sample use of Azure Table Storage.
# *               Full load of stocks data (2013-2017).
# * 
# ******************************************************
...
function Load-Stocks-2-TableStorage {
    ...
    # Debugging - load just 4 files
    # $List = $List | Select-Object -First 4
    # $List = $List | Select-Object -Last 4
...
-StorageTbl "ts4stocks" -RootPath "C:\COMMUNITY WORK\STAGING\DATA\" `
