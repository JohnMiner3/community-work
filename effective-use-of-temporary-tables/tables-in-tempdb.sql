/******************************************************
 *
 * Name:         tables-in-tempdb.sql
 *     
 * Design Phase:
 *     Author:   John Miner
 *     Date:     10-09-2012
 *     Purpose:  Samples of tables in tempdb.
 * 
 ******************************************************/
...
-- Database selection does matter!
USE tempdb;
GO
...
-- Add data to regular table in tempdb
...
-- Just look for table since we are in tempdb
