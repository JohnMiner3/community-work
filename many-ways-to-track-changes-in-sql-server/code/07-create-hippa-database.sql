/******************************************************
 *
 * Name:         07-create-hippa-database.sql
 *     
 * Design Phase:
 *     Author:   John Miner
 *     Date:     05-01-2026
...
DROP DATABASE IF EXISTS dbs_hippa04
GO
...
-- Add new database
CREATE DATABASE [dbs_hippa04] ON  
 PRIMARY 
  ( NAME = N'hippa4_pri_dat', FILENAME = N'f:\data\hippa04.mdf' , SIZE = 32MB, FILEGROWTH = 16MB) 
 LOG ON 
  ( NAME = N'hippa4_all_log', FILENAME = N'g:\log\hippa04.ldf' , SIZE = 16MB, FILEGROWTH = 16MB)
GO
