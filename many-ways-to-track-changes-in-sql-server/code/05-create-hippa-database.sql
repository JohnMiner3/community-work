/******************************************************
 *
 * Name:         05-create-hippa-database.sql
 *     
 * Design Phase:
 *     Author:   John Miner
 *     Date:     05-01-2026
 *     Purpose:  Make sample database
 * 
 ******************************************************/
...
DROP DATABASE IF EXISTS dbs_hippa03
GO
...
--
-- hippa database (on premise code)
--

-- Add new database
CREATE DATABASE [dbs_hippa03] ON  
 PRIMARY 
  ( NAME = N'hippa3_pri_dat', FILENAME = N'f:\data\hippa03.mdf' , SIZE = 32MB, FILEGROWTH = 16MB) 
 LOG ON 
  ( NAME = N'hippa3_all_log', FILENAME = N'g:\log\hippa03.ldf' , SIZE = 16MB, FILEGROWTH = 16MB)
GO
...
--
--  Create x records for patient table
--
...
--
--  Create x records 4 visit table
--
