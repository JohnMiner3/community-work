/******************************************************
 *
 * Name:         09-create-hippa-database.sql
 *     
 * Design Phase:
 *     Author:   John Miner
 *     Date:     05-01-2026
...
DROP DATABASE IF EXISTS dbs_hippa05
GO
...
-- Add new database
CREATE DATABASE [dbs_hippa05] ON  
 PRIMARY 
  ( NAME = N'hippa5_pri_dat', FILENAME = N'f:\data\hippa05.mdf' , SIZE = 32MB, FILEGROWTH = 16MB) 
 LOG ON 
  ( NAME = N'hippa5_all_log', FILENAME = N'g:\log\hippa05.ldf' , SIZE = 16MB, FILEGROWTH = 16MB)
GO
