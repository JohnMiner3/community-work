/******************************************************
 *
 * Name:         03-create-hippa-database.sql
 *     
 * Design Phase:
 *     Author:   John Miner
 *     Date:     05-01-2026
...
DROP DATABASE IF EXISTS dbs_hippa02
GO
...
-- Add new database
CREATE DATABASE [dbs_hippa02] ON  
 PRIMARY 
  ( NAME = N'hippa2_pri_dat', FILENAME = N'f:\data\hippa02.mdf' , SIZE = 32MB, FILEGROWTH = 16MB) 
 LOG ON 
  ( NAME = N'hippa2_all_log', FILENAME = N'g:\log\hippa02.ldf' , SIZE = 16MB, FILEGROWTH = 16MB)
GO
