/******************************************************
 *
 * Name:         01-create-hippa-database.sql
 *     
 * Design Phase:
 *     Author:   John Miner
 *     Date:     05-01-2026
...
DROP DATABASE IF EXISTS dbs_hippa01
GO
...
-- Add new database
CREATE DATABASE [dbs_hippa01] ON  
 PRIMARY 
  ( NAME = N'hippa_pri_dat', FILENAME = N'f:\data\hippa01.mdf' , SIZE = 32MB, FILEGROWTH = 16MB) 
 LOG ON 
  ( NAME = N'hippa_all_log', FILENAME = N'g:\log\hippa01.ldf' , SIZE = 16MB, FILEGROWTH = 16MB)
GO
